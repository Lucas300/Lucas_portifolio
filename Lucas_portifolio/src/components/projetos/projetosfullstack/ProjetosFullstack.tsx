                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-20 mx-auto max-w-7xl">
                    ...
                    <div className="bg-slate-800 rounded-xl shadow-md p-4 max-w-xs mb-4 mx-auto">
                        ...
                        <div className="flex justify-center gap-4 mb-4">
                            ...
                            <img src="https://skillicons.dev/icons?i=js" className="w-6 transition duration-300 hover:scale-125" alt="JavaScript" />
                        </div>
                        <div className="text-center">
                            <p className="text-lg text-gray-600 mb-4">Projeto Fitness para exercício ao ar livre</p>
                        </div>
